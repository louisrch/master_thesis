...
parser.add_argument("--pooling", type=str, default="none", help="pooling type, (average, sum, max, none)")
...
parser.add_argument('--batch_size', type=int, default=512, help='batch size (512 for MetaWorld, 1024 for walker, default:512)')
